...
window.pages.renderAttendance = function() {
  ...
  return `
    <div class="min-h-[calc(100vh-4rem)] -m-4 md:-m-6 lg:-m-8 p-4 md:p-6 lg:p-8 bg-[#0a3d2e] font-sans">
      <div class="max-w-md mx-auto space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        
        <!-- Header -->
        <div class="text-center pt-6 pb-2">
          <div class="w-12 h-12 mx-auto mb-3 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/20">
             <i data-lucide="building-2" class="w-7 h-7 text-white"></i>
          </div>
          <h1 class="text-2xl font-bold text-white mb-1 tracking-tight">Absensi <span class="text-emerald-400">Digital</span></h1>
        ...
        <div class="bg-white/5 backdrop-blur-md rounded-3xl p-4 flex items-center justify-between gap-4 border border-white/10 shadow-lg">
          <div class="flex items-center gap-4 w-full">
            <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-green-500 flex items-center justify-center shadow-lg shrink-0">
            ...
            <div class="px-4 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-xs font-bold shrink-0">
              Aktif
            </div>
          </div>
        </div>
        ...
        <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 md:p-8 text-center space-y-3 border border-white/10 shadow-lg mt-2">
          <div>
            ...
            <div id="att-hijri" class="text-sm font-bold italic text-emerald-400 mt-1"></div>
          </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <!-- Absen Masuk -->
          <button onclick="handleAbsen('Masuk')" class="flex flex-col items-center justify-center gap-5 p-6 rounded-3xl bg-gradient-to-br from-emerald-400 to-green-600 text-white shadow-lg shadow-emerald-900/30 hover:scale-105 transition-transform active:scale-95 group border border-emerald-400/20">
