...
window.router = {
  ...
  routes: {
    ...
    'report-weekly':  { render: () => window.pages.renderReportWeekly(),  layout: 'admin', title: 'Laporan Mingguan' },
    'report-yearly':  { render: () => window.pages.renderReportYearly(),  layout: 'admin', title: 'Laporan Tahunan' },
    'report-emp-history':     { render: () => window.pages.renderReportEmpHistory(),     layout: 'admin', title: 'Riwayat Karyawan' },
    'report-teacher-history': { render: () => window.pages.renderReportTeacherHistory(), layout: 'admin', title: 'Riwayat Guru' },
    'report-late':        { render: () => window.pages.renderReportLate(),        layout: 'admin', title: 'Laporan Keterlambatan' },
    'report-absent':      { render: () => window.pages.renderReportAbsent(),      layout: 'admin', title: 'Laporan Ketidakhadiran' },
    'report-permission':  { render: () => window.pages.renderReportPermission(),  layout: 'admin', title: 'Laporan Izin' },
    'report-sick':        { render: () => window.pages.renderReportSick(),        layout: 'admin', title: 'Laporan Sakit' },
    'report-performance': { render: () => window.pages.renderReportPerformance(), layout: 'admin', title: 'Performa Kehadiran' },
    'report-compare-unit':  { render: () => window.pages.renderReportCompareUnit(),  layout: 'admin', title: 'Perbandingan Unit' },
    'report-compare-month': { render: () => window.pages.renderReportCompareMonth(), layout: 'admin', title: 'Perbandingan Bulan' },
    'report-compare-year':  { render: () => window.pages.renderReportCompareYear(),  layout: 'admin', title: 'Perbandingan Tahun' },
    'report-top-discipline': { render: () => window.pages.renderReportTopDiscipline(), layout: 'admin', title: 'Pegawai Terdisiplin' },
